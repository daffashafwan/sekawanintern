...
<div class="login-box">
  ...
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      <a href="../../index2.html" class="h2"><b>Sistem </b>Pemesanan Kendaraan</a>
    </div>
    <div class="card-body">
      <p class="login-box-msg">Login sebagai penyetuju <a href="{{route('auth.penyetuju.index')}}">disini</a></p>
